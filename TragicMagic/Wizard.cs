...
// Depends on: WizardWand, ComboSystem, GameWands
...
namespace TragicMagic
{
	...
	class WizardClass : Entity
	{
		...
		private static float SPRITESCALE = 0.2f; // Scale down the wizard body & wand sprites
		...
		// TODO: Needs to be able to set the angle of the wizard, position, set reference to GameWands
		...
		public override void Update()
		{
			...
			Body.SetPosition( Position.X, Position.Y );
			Wand.SetPosition( Position.X + WandOffset.X, Position.Y + WandOffset.Y );
			Wand.Angle = Angle + Rand.Float( -35, 35 );
		}
